  ...
  public void testCheckCreationBytes() throws AtException {
    ...
    assertEquals(
        ...
        AtController.checkCreationBytes(
            AtTestHelper.HELLO_WORLD_CREATION_BYTES, Integer.MAX_VALUE));
    assertEquals(
        4, AtController.checkCreationBytes(AtTestHelper.ECHO_CREATION_BYTES, Integer.MAX_VALUE));
    assertEquals(
        5,
        AtController.checkCreationBytes(AtTestHelper.TIP_THANKS_CREATION_BYTES, Integer.MAX_VALUE));
  }
