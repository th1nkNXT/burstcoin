...
public class AtTestHelper {
  ...
  static byte[] HELLO_WORLD_CREATION_BYTES =
      getCreationBytes(
          1,
  ...
  static byte[] ECHO_CREATION_BYTES =
      getCreationBytes(
          1,
          Convert.parseHexString(
  ...
  static byte[] TIP_THANKS_CREATION_BYTES =
      getCreationBytes(
          2,
          Convert.parseHexString(
  ...
  static void setupMocks() {
    ...
    when(mockAccountStore.setOrVerify(
    ...
    doAnswer(
        ...
        .when(mockAtStore)
        .getAT(ArgumentMatchers.anyLong());
    doAnswer(
            invoke -> {
              Long atId = invoke.getArgument(0);
              for (AT addedAt : addedAts) {
        ...
        .when(mockAtStore)
        .getAT(ArgumentMatchers.anyLong(), ArgumentMatchers.anyInt());
    when(mockAtTable.getAll(ArgumentMatchers.anyInt(), ArgumentMatchers.anyInt()))
        .thenReturn(addedAts);
    ...
    when(mockPropertyService.getBoolean(ArgumentMatchers.eq(Props.ENABLE_AT_DEBUG_LOG)))
        .thenReturn(true);
  ...
  public static void addHelloWorldAT() {
    AT.addAT(
        ...
        "HelloWorld",
        "Hello World AT",
        AtTestHelper.HELLO_WORLD_CREATION_BYTES,
        Integer.MAX_VALUE);
  }
  ...
  public static void addEchoAT() {
    AT.addAT(
        ...
        "Echo",
        "Message Echo AT",
        AtTestHelper.ECHO_CREATION_BYTES,
        Integer.MAX_VALUE);
  }
  ...
  public static void addTipThanksAT() {
    AT.addAT(
        ...
        "TipThanks",
        "Tip Thanks AT",
        AtTestHelper.TIP_THANKS_CREATION_BYTES,
        Integer.MAX_VALUE);
  }
}
