...
public class DeeplinkGeneratorTest {
  ...
  @Test
  public void testDeeplinkGenerator_InvalidDomain_WithWhitespace()
  ...
  @Test
  public void testDeeplinkGenerator_InvalidDomain_WithSpecialCahr()
      throws UnsupportedEncodingException {
    try {
      deeplinkGenerator.generateDeepLink("test-123", "testAction", null);
    } catch (IllegalArgumentException e) {
  ...
  public void testDeeplinkGenerator_QrCode() throws WriterException, UnsupportedEncodingException {
    BufferedImage bufferedImage =
        deeplinkGenerator.generateDeepLinkQrCode("generic", "testAction", "dGVzdERhdGE=");
