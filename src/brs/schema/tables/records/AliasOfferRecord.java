...
public class AliasOfferRecord extends UpdatableRecordImpl<AliasOfferRecord>
    implements Record6<Long, Long, Long, Long, Integer, Boolean> {
  ...
  /** {@inheritDoc} */
  @Override
  public AliasOfferRecord values(
      Long value1, Long value2, Long value3, Long value4, Integer value5, Boolean value6) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
  ...
  public AliasOfferRecord(
      Long dbId, Long id, Long price, Long buyerId, Integer height, Boolean latest) {
    super(AliasOffer.ALIAS_OFFER);
