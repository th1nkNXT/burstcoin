...
public class AtStateRecord extends UpdatableRecordImpl<AtStateRecord>
    implements Record11<
        Long, Long, byte[], Integer, Integer, Integer, Long, Boolean, Long, Integer, Boolean> {
  ...
  /** {@inheritDoc} */
  @Override
  public Row11<Long, Long, byte[], Integer, Integer, Integer, Long, Boolean, Long, Integer, Boolean>
      fieldsRow() {
  ...
  public AtStateRecord(
      ...
      Integer prevHeight,
      Integer nextHeight,
      Integer sleepBetween,
      Long prevBalance,
      Boolean freezeWhenSameBalance,
      Long minActivateAmount,
      Integer height,
      Boolean latest) {
    super(AtState.AT_STATE);
