...
public class EscrowRecord extends UpdatableRecordImpl<EscrowRecord>
    implements Record10<Long, Long, Long, Long, Long, Integer, Integer, Integer, Integer, Boolean> {
  ...
  /** {@inheritDoc} */
  @Override
  public Row10<Long, Long, Long, Long, Long, Integer, Integer, Integer, Integer, Boolean>
      fieldsRow() {
  ...
  public EscrowRecord(
      ...
      Long recipientId,
      Long amount,
      Integer requiredSigners,
      Integer deadline,
      Integer deadlineAction,
      Integer height,
      Boolean latest) {
    super(Escrow.ESCROW);
