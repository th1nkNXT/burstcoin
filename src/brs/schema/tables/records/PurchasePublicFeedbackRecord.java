...
public class PurchasePublicFeedbackRecord extends UpdatableRecordImpl<PurchasePublicFeedbackRecord>
    implements Record5<Long, Long, String, Integer, Boolean> {
  ...
  /** {@inheritDoc} */
  @Override
  public PurchasePublicFeedbackRecord values(
      Long value1, Long value2, String value3, Integer value4, Boolean value5) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
  ...
  public PurchasePublicFeedbackRecord(
      Long dbId, Long id, String publicFeedback, Integer height, Boolean latest) {
    super(PurchasePublicFeedback.PURCHASE_PUBLIC_FEEDBACK);
