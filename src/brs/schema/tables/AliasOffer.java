...
public class AliasOffer extends TableImpl<AliasOfferRecord> {
  ...
  private static final long serialVersionUID = -1594608385;
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.ALIAS_OFFER_ALIAS_OFFER_ID_HEIGHT_IDX, Indexes.ALIAS_OFFER_PRIMARY);
  }
  ...
  public List<UniqueKey<AliasOfferRecord>> getKeys() {
    return Arrays.<UniqueKey<AliasOfferRecord>>asList(
        Keys.KEY_ALIAS_OFFER_PRIMARY, Keys.KEY_ALIAS_OFFER_ALIAS_OFFER_ID_HEIGHT_IDX);
  }
