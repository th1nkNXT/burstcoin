...
public class Escrow extends TableImpl<EscrowRecord> {
  ...
  private static final long serialVersionUID = 1755976791;
  ...
  public final TableField<EscrowRecord, Integer> DEADLINE =
      createField("deadline", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.escrow.deadline_action</code>. */
  public final TableField<EscrowRecord, Integer> DEADLINE_ACTION =
      createField("deadline_action", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.escrow.height</code>. */
  public final TableField<EscrowRecord, Integer> HEIGHT =
      createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.escrow.latest</code>. */
  public final TableField<EscrowRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.ESCROW_ESCROW_DEADLINE_HEIGHT_IDX,
        Indexes.ESCROW_ESCROW_ID_HEIGHT_IDX,
        Indexes.ESCROW_ESCROW_RECIPIENT_ID_HEIGHT_IDX,
        Indexes.ESCROW_ESCROW_SENDER_ID_HEIGHT_IDX,
        Indexes.ESCROW_PRIMARY);
  }
  ...
  public List<UniqueKey<EscrowRecord>> getKeys() {
    return Arrays.<UniqueKey<EscrowRecord>>asList(
        Keys.KEY_ESCROW_PRIMARY, Keys.KEY_ESCROW_ESCROW_ID_HEIGHT_IDX);
  }
