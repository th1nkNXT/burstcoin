...
public class Alias extends TableImpl<AliasRecord> {
  ...
  public final TableField<AliasRecord, Long> DB_ID =
      createField(
          "db_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>DB.alias.id</code>. */
  public final TableField<AliasRecord, Long> ID =
      createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.alias.account_id</code>. */
  public final TableField<AliasRecord, Long> ACCOUNT_ID =
      createField("account_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.alias.alias_name</code>. */
  public final TableField<AliasRecord, String> ALIAS_NAME =
      createField("alias_name", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

  /** The column <code>DB.alias.alias_name_lower</code>. */
  public final TableField<AliasRecord, String> ALIAS_NAME_LOWER =
      createField(
          "alias_name_lower", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

  /** The column <code>DB.alias.alias_uri</code>. */
  public final TableField<AliasRecord, String> ALIAS_URI =
      createField("alias_uri", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

  /** The column <code>DB.alias.timestamp</code>. */
  public final TableField<AliasRecord, Integer> TIMESTAMP =
      createField("timestamp", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.alias.height</code>. */
  public final TableField<AliasRecord, Integer> HEIGHT =
      createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.alias.latest</code>. */
  public final TableField<AliasRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.ALIAS_ALIAS_ACCOUNT_ID_IDX,
        Indexes.ALIAS_ALIAS_ID_HEIGHT_IDX,
        Indexes.ALIAS_ALIAS_NAME_LOWER_IDX,
        Indexes.ALIAS_PRIMARY);
  }
  ...
  public List<UniqueKey<AliasRecord>> getKeys() {
    return Arrays.<UniqueKey<AliasRecord>>asList(
        Keys.KEY_ALIAS_PRIMARY, Keys.KEY_ALIAS_ALIAS_ID_HEIGHT_IDX);
  }
