...
public class EscrowDecision extends TableImpl<EscrowDecisionRecord> {
  ...
  public final TableField<EscrowDecisionRecord, Long> DB_ID =
      createField(
  ...
  public final TableField<EscrowDecisionRecord, Long> ESCROW_ID =
      createField("escrow_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.escrow_decision.account_id</code>. */
  public final TableField<EscrowDecisionRecord, Long> ACCOUNT_ID =
  ...
  public final TableField<EscrowDecisionRecord, Integer> DECISION =
      createField("decision", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.escrow_decision.height</code>. */
  public final TableField<EscrowDecisionRecord, Integer> HEIGHT =
      createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.escrow_decision.latest</code>. */
  public final TableField<EscrowDecisionRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  public <O extends Record> EscrowDecision(
      Table<O> child, ForeignKey<O, EscrowDecisionRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.ESCROW_DECISION_ESCROW_DECISION_ACCOUNT_ID_HEIGHT_IDX,
        Indexes.ESCROW_DECISION_ESCROW_DECISION_ESCROW_ID_ACCOUNT_ID_HEIGHT_IDX,
        Indexes.ESCROW_DECISION_ESCROW_DECISION_ESCROW_ID_HEIGHT_IDX,
        Indexes.ESCROW_DECISION_PRIMARY);
  }
  ...
  public List<UniqueKey<EscrowDecisionRecord>> getKeys() {
    return Arrays.<UniqueKey<EscrowDecisionRecord>>asList(
        Keys.KEY_ESCROW_DECISION_PRIMARY,
        Keys.KEY_ESCROW_DECISION_ESCROW_DECISION_ESCROW_ID_ACCOUNT_ID_HEIGHT_IDX);
  }
