...
public class RewardRecipAssign extends TableImpl<RewardRecipAssignRecord> {
  ...
  public final TableField<RewardRecipAssignRecord, Long> DB_ID =
      createField(
  ...
  public final TableField<RewardRecipAssignRecord, Long> ACCOUNT_ID =
      createField("account_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.reward_recip_assign.prev_recip_id</code>. */
  public final TableField<RewardRecipAssignRecord, Long> PREV_RECIP_ID =
      createField("prev_recip_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.reward_recip_assign.recip_id</code>. */
  public final TableField<RewardRecipAssignRecord, Long> RECIP_ID =
      createField("recip_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.reward_recip_assign.from_height</code>. */
  public final TableField<RewardRecipAssignRecord, Integer> FROM_HEIGHT =
      createField("from_height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.reward_recip_assign.height</code>. */
  public final TableField<RewardRecipAssignRecord, Integer> HEIGHT =
  ...
  public final TableField<RewardRecipAssignRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  private RewardRecipAssign(
      Name alias, Table<RewardRecipAssignRecord> aliased, Field<?>[] parameters) {
    super(alias, null, aliased, parameters, DSL.comment(""));
  }

  public <O extends Record> RewardRecipAssign(
      Table<O> child, ForeignKey<O, RewardRecipAssignRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.REWARD_RECIP_ASSIGN_PRIMARY,
        Indexes.REWARD_RECIP_ASSIGN_REWARD_RECIP_ASSIGN_ACCOUNT_ID_HEIGHT_IDX,
        Indexes.REWARD_RECIP_ASSIGN_REWARD_RECIP_ASSIGN_RECIP_ID_HEIGHT_IDX);
  }
  ...
  public List<UniqueKey<RewardRecipAssignRecord>> getKeys() {
    return Arrays.<UniqueKey<RewardRecipAssignRecord>>asList(
        Keys.KEY_REWARD_RECIP_ASSIGN_PRIMARY,
        Keys.KEY_REWARD_RECIP_ASSIGN_REWARD_RECIP_ASSIGN_ACCOUNT_ID_HEIGHT_IDX);
  }
