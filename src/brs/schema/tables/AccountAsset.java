...
public class AccountAsset extends TableImpl<AccountAssetRecord> {
  ...
  public final TableField<AccountAssetRecord, Long> UNCONFIRMED_QUANTITY =
      createField(
          "unconfirmed_quantity", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.account_asset.height</code>. */
  public final TableField<AccountAssetRecord, Integer> HEIGHT =
      createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.account_asset.latest</code>. */
  public final TableField<AccountAssetRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.ACCOUNT_ASSET_ACCOUNT_ASSET_ID_HEIGHT_IDX,
        Indexes.ACCOUNT_ASSET_ACCOUNT_ASSET_QUANTITY_IDX,
        Indexes.ACCOUNT_ASSET_PRIMARY);
  }
  ...
  public List<UniqueKey<AccountAssetRecord>> getKeys() {
    return Arrays.<UniqueKey<AccountAssetRecord>>asList(
        Keys.KEY_ACCOUNT_ASSET_PRIMARY, Keys.KEY_ACCOUNT_ASSET_ACCOUNT_ASSET_ID_HEIGHT_IDX);
  }
