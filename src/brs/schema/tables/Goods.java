...
public class Goods extends TableImpl<GoodsRecord> {
  ...
  private static final long serialVersionUID = -1374783688;
  ...
  public final TableField<GoodsRecord, String> NAME =
      createField("name", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

  /** The column <code>DB.goods.description</code>. */
  public final TableField<GoodsRecord, String> DESCRIPTION =
      createField(
          "description",
  ...
  public final TableField<GoodsRecord, String> TAGS =
      createField(
          "tags",
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.GOODS_GOODS_ID_HEIGHT_IDX,
        Indexes.GOODS_GOODS_SELLER_ID_NAME_IDX,
        Indexes.GOODS_GOODS_TIMESTAMP_IDX,
        Indexes.GOODS_PRIMARY);
  }
  ...
  public List<UniqueKey<GoodsRecord>> getKeys() {
    return Arrays.<UniqueKey<GoodsRecord>>asList(
        Keys.KEY_GOODS_PRIMARY, Keys.KEY_GOODS_GOODS_ID_HEIGHT_IDX);
  }
