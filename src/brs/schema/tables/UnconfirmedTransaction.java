...
public class UnconfirmedTransaction extends TableImpl<UnconfirmedTransactionRecord> {
  ...
  private static final long serialVersionUID = 935521231;
  ...
  public final TableField<UnconfirmedTransactionRecord, Long> DB_ID =
      createField(
  ...
  public final TableField<UnconfirmedTransactionRecord, Long> ID =
  ...
  public final TableField<UnconfirmedTransactionRecord, Integer> EXPIRATION =
      createField("expiration", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.unconfirmed_transaction.transaction_height</code>. */
  public final TableField<UnconfirmedTransactionRecord, Integer> TRANSACTION_HEIGHT =
      createField(
          "transaction_height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.unconfirmed_transaction.fee_per_byte</code>. */
  public final TableField<UnconfirmedTransactionRecord, Long> FEE_PER_BYTE =
      createField("fee_per_byte", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.unconfirmed_transaction.timestamp</code>. */
  public final TableField<UnconfirmedTransactionRecord, Integer> TIMESTAMP =
  ...
  public final TableField<UnconfirmedTransactionRecord, byte[]> TRANSACTION_BYTES =
      createField("transaction_bytes", org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

  /** The column <code>DB.unconfirmed_transaction.height</code>. */
  public final TableField<UnconfirmedTransactionRecord, Integer> HEIGHT =
  ...
  private UnconfirmedTransaction(
      Name alias, Table<UnconfirmedTransactionRecord> aliased, Field<?>[] parameters) {
    super(alias, null, aliased, parameters, DSL.comment(""));
  }

  public <O extends Record> UnconfirmedTransaction(
      Table<O> child, ForeignKey<O, UnconfirmedTransactionRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.UNCONFIRMED_TRANSACTION_PRIMARY,
        Indexes.UNCONFIRMED_TRANSACTION_UNCONFIRMED_TRANSACTION_HEIGHT_FEE_TIMESTAMP_IDX,
        Indexes.UNCONFIRMED_TRANSACTION_UNCONFIRMED_TRANSACTION_ID_IDX);
  }
  ...
  public List<UniqueKey<UnconfirmedTransactionRecord>> getKeys() {
    return Arrays.<UniqueKey<UnconfirmedTransactionRecord>>asList(
        Keys.KEY_UNCONFIRMED_TRANSACTION_PRIMARY,
        Keys.KEY_UNCONFIRMED_TRANSACTION_UNCONFIRMED_TRANSACTION_ID_IDX);
  }
