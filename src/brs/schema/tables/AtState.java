...
public class AtState extends TableImpl<AtStateRecord> {
  ...
  public final TableField<AtStateRecord, Long> DB_ID =
      createField(
          "db_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>DB.at_state.at_id</code>. */
  public final TableField<AtStateRecord, Long> AT_ID =
      createField("at_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.at_state.state</code>. */
  public final TableField<AtStateRecord, byte[]> STATE =
      createField("state", org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

  /** The column <code>DB.at_state.prev_height</code>. */
  public final TableField<AtStateRecord, Integer> PREV_HEIGHT =
      createField("prev_height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at_state.next_height</code>. */
  public final TableField<AtStateRecord, Integer> NEXT_HEIGHT =
      createField("next_height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at_state.sleep_between</code>. */
  public final TableField<AtStateRecord, Integer> SLEEP_BETWEEN =
      createField("sleep_between", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at_state.prev_balance</code>. */
  public final TableField<AtStateRecord, Long> PREV_BALANCE =
      createField("prev_balance", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.at_state.freeze_when_same_balance</code>. */
  public final TableField<AtStateRecord, Boolean> FREEZE_WHEN_SAME_BALANCE =
      createField(
          "freeze_when_same_balance", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");

  /** The column <code>DB.at_state.min_activate_amount</code>. */
  public final TableField<AtStateRecord, Long> MIN_ACTIVATE_AMOUNT =
      createField(
          "min_activate_amount", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.at_state.height</code>. */
  public final TableField<AtStateRecord, Integer> HEIGHT =
      createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at_state.latest</code>. */
  public final TableField<AtStateRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.AT_STATE_AT_STATE_AT_ID_HEIGHT_IDX,
        Indexes.AT_STATE_AT_STATE_ID_NEXT_HEIGHT_HEIGHT_IDX,
        Indexes.AT_STATE_PRIMARY);
  }
  ...
  public List<UniqueKey<AtStateRecord>> getKeys() {
    return Arrays.<UniqueKey<AtStateRecord>>asList(
        Keys.KEY_AT_STATE_PRIMARY, Keys.KEY_AT_STATE_AT_STATE_AT_ID_HEIGHT_IDX);
  }
