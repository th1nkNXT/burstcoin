...
public class Asset extends TableImpl<AssetRecord> {
  ...
  private static final long serialVersionUID = -1159698902;
  ...
  public final TableField<AssetRecord, Long> QUANTITY =
      createField("quantity", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.asset.decimals</code>. */
  public final TableField<AssetRecord, Byte> DECIMALS =
      createField("decimals", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

  /** The column <code>DB.asset.height</code>. */
  public final TableField<AssetRecord, Integer> HEIGHT =
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.ASSET_ASSET_ACCOUNT_ID_IDX, Indexes.ASSET_ASSET_ID_IDX, Indexes.ASSET_PRIMARY);
  }
  ...
  public List<UniqueKey<AssetRecord>> getKeys() {
    return Arrays.<UniqueKey<AssetRecord>>asList(
        Keys.KEY_ASSET_PRIMARY, Keys.KEY_ASSET_ASSET_ID_IDX);
  }
