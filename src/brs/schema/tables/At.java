...
public class At extends TableImpl<AtRecord> {
  ...
  private static final long serialVersionUID = 2139538492;
  ...
  public final TableField<AtRecord, Long> DB_ID =
      createField(
          "db_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>DB.at.id</code>. */
  public final TableField<AtRecord, Long> ID =
      createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.at.creator_id</code>. */
  public final TableField<AtRecord, Long> CREATOR_ID =
      createField("creator_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.at.name</code>. */
  public final TableField<AtRecord, String> NAME =
      createField(
          "name",
          org.jooq.impl.SQLDataType.VARCHAR(30)
              .defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)),
          this,
          "");

  /** The column <code>DB.at.description</code>. */
  public final TableField<AtRecord, String> DESCRIPTION =
      createField(
          "description",
  ...
  public final TableField<AtRecord, Short> VERSION =
      createField("version", org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

  /** The column <code>DB.at.csize</code>. */
  public final TableField<AtRecord, Integer> CSIZE =
      createField("csize", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at.dsize</code>. */
  public final TableField<AtRecord, Integer> DSIZE =
      createField("dsize", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at.c_user_stack_bytes</code>. */
  public final TableField<AtRecord, Integer> C_USER_STACK_BYTES =
      createField(
          "c_user_stack_bytes", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at.c_call_stack_bytes</code>. */
  public final TableField<AtRecord, Integer> C_CALL_STACK_BYTES =
      createField(
          "c_call_stack_bytes", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at.creation_height</code>. */
  public final TableField<AtRecord, Integer> CREATION_HEIGHT =
      createField("creation_height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at.ap_code</code>. */
  public final TableField<AtRecord, byte[]> AP_CODE =
      createField("ap_code", org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

  /** The column <code>DB.at.height</code>. */
  public final TableField<AtRecord, Integer> HEIGHT =
      createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.at.latest</code>. */
  public final TableField<AtRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.AT_AT_CREATOR_ID_HEIGHT_IDX, Indexes.AT_AT_ID_HEIGHT_IDX, Indexes.AT_PRIMARY);
  }
