...
public class PurchaseFeedback extends TableImpl<PurchaseFeedbackRecord> {
  ...
  public final TableField<PurchaseFeedbackRecord, byte[]> FEEDBACK_DATA =
      createField("feedback_data", org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

  /** The column <code>DB.purchase_feedback.feedback_nonce</code>. */
  public final TableField<PurchaseFeedbackRecord, byte[]> FEEDBACK_NONCE =
      createField(
          "feedback_nonce", org.jooq.impl.SQLDataType.VARBINARY(32).nullable(false), this, "");

  /** The column <code>DB.purchase_feedback.height</code>. */
  public final TableField<PurchaseFeedbackRecord, Integer> HEIGHT =
      createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.purchase_feedback.latest</code>. */
  public final TableField<PurchaseFeedbackRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  private PurchaseFeedback(
      Name alias, Table<PurchaseFeedbackRecord> aliased, Field<?>[] parameters) {
    super(alias, null, aliased, parameters, DSL.comment(""));
  }

  public <O extends Record> PurchaseFeedback(
      Table<O> child, ForeignKey<O, PurchaseFeedbackRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.PURCHASE_FEEDBACK_PRIMARY,
        Indexes.PURCHASE_FEEDBACK_PURCHASE_FEEDBACK_ID_HEIGHT_IDX);
  }
