...
public class PurchasePublicFeedback extends TableImpl<PurchasePublicFeedbackRecord> {
  ...
  public final TableField<PurchasePublicFeedbackRecord, Long> DB_ID =
      createField(
  ...
  public final TableField<PurchasePublicFeedbackRecord, Long> ID =
  ...
  public final TableField<PurchasePublicFeedbackRecord, String> PUBLIC_FEEDBACK =
      createField("public_feedback", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

  /** The column <code>DB.purchase_public_feedback.height</code>. */
  public final TableField<PurchasePublicFeedbackRecord, Integer> HEIGHT =
  ...
  public final TableField<PurchasePublicFeedbackRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  private PurchasePublicFeedback(
      Name alias, Table<PurchasePublicFeedbackRecord> aliased, Field<?>[] parameters) {
    super(alias, null, aliased, parameters, DSL.comment(""));
  }

  public <O extends Record> PurchasePublicFeedback(
      Table<O> child, ForeignKey<O, PurchasePublicFeedbackRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.PURCHASE_PUBLIC_FEEDBACK_PRIMARY,
        Indexes.PURCHASE_PUBLIC_FEEDBACK_PURCHASE_PUBLIC_FEEDBACK_ID_HEIGHT_IDX);
  }
  ...
  public List<UniqueKey<PurchasePublicFeedbackRecord>> getKeys() {
    return Arrays.<UniqueKey<PurchasePublicFeedbackRecord>>asList(
        Keys.KEY_PURCHASE_PUBLIC_FEEDBACK_PRIMARY);
  }
