...
public class AskOrder extends TableImpl<AskOrderRecord> {
  ...
  public final TableField<AskOrderRecord, Integer> CREATION_HEIGHT =
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.ASK_ORDER_ASK_ORDER_ACCOUNT_ID_IDX,
        Indexes.ASK_ORDER_ASK_ORDER_ASSET_ID_PRICE_IDX,
        Indexes.ASK_ORDER_ASK_ORDER_CREATION_IDX,
        Indexes.ASK_ORDER_ASK_ORDER_ID_HEIGHT_IDX,
        Indexes.ASK_ORDER_PRIMARY);
  }
  ...
  public List<UniqueKey<AskOrderRecord>> getKeys() {
    return Arrays.<UniqueKey<AskOrderRecord>>asList(
        Keys.KEY_ASK_ORDER_PRIMARY, Keys.KEY_ASK_ORDER_ASK_ORDER_ID_HEIGHT_IDX);
  }
