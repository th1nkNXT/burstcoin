...
public class Trade extends TableImpl<TradeRecord> {
  ...
  public final TableField<TradeRecord, Long> DB_ID =
      createField(
          "db_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>DB.trade.asset_id</code>. */
  public final TableField<TradeRecord, Long> ASSET_ID =
      createField("asset_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.trade.block_id</code>. */
  public final TableField<TradeRecord, Long> BLOCK_ID =
      createField("block_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.trade.ask_order_id</code>. */
  public final TableField<TradeRecord, Long> ASK_ORDER_ID =
      createField("ask_order_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.trade.bid_order_id</code>. */
  public final TableField<TradeRecord, Long> BID_ORDER_ID =
      createField("bid_order_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.trade.ask_order_height</code>. */
  public final TableField<TradeRecord, Integer> ASK_ORDER_HEIGHT =
      createField("ask_order_height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.trade.bid_order_height</code>. */
  public final TableField<TradeRecord, Integer> BID_ORDER_HEIGHT =
      createField("bid_order_height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.trade.seller_id</code>. */
  public final TableField<TradeRecord, Long> SELLER_ID =
      createField("seller_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.trade.buyer_id</code>. */
  public final TableField<TradeRecord, Long> BUYER_ID =
      createField("buyer_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.trade.quantity</code>. */
  public final TableField<TradeRecord, Long> QUANTITY =
      createField("quantity", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.trade.price</code>. */
  public final TableField<TradeRecord, Long> PRICE =
      createField("price", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.trade.timestamp</code>. */
  public final TableField<TradeRecord, Integer> TIMESTAMP =
      createField("timestamp", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.trade.height</code>. */
  public final TableField<TradeRecord, Integer> HEIGHT =
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.TRADE_PRIMARY,
        Indexes.TRADE_TRADE_ASK_BID_IDX,
        Indexes.TRADE_TRADE_ASSET_ID_IDX,
        Indexes.TRADE_TRADE_BUYER_ID_IDX,
        Indexes.TRADE_TRADE_SELLER_ID_IDX);
  }
  ...
  public List<UniqueKey<TradeRecord>> getKeys() {
    return Arrays.<UniqueKey<TradeRecord>>asList(
        Keys.KEY_TRADE_PRIMARY, Keys.KEY_TRADE_TRADE_ASK_BID_IDX);
  }
