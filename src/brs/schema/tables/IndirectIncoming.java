...
public class IndirectIncoming extends TableImpl<IndirectIncomingRecord> {
  ...
  public final TableField<IndirectIncomingRecord, Long> DB_ID =
      createField(
  ...
  public final TableField<IndirectIncomingRecord, Long> ACCOUNT_ID =
  ...
  public final TableField<IndirectIncomingRecord, Long> TRANSACTION_ID =
      createField("transaction_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.indirect_incoming.height</code>. */
  public final TableField<IndirectIncomingRecord, Integer> HEIGHT =
  ...
  private IndirectIncoming(
      Name alias, Table<IndirectIncomingRecord> aliased, Field<?>[] parameters) {
    super(alias, null, aliased, parameters, DSL.comment(""));
  }

  public <O extends Record> IndirectIncoming(
      Table<O> child, ForeignKey<O, IndirectIncomingRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.INDIRECT_INCOMING_INDIRECT_INCOMING_DB_ID_UINDEX,
        Indexes.INDIRECT_INCOMING_PRIMARY);
  }
  ...
  public List<UniqueKey<IndirectIncomingRecord>> getKeys() {
    return Arrays.<UniqueKey<IndirectIncomingRecord>>asList(
        Keys.KEY_INDIRECT_INCOMING_PRIMARY,
        Keys.KEY_INDIRECT_INCOMING_INDIRECT_INCOMING_DB_ID_UINDEX);
  }
