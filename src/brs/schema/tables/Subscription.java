...
public class Subscription extends TableImpl<SubscriptionRecord> {
  ...
  public final TableField<SubscriptionRecord, Long> RECIPIENT_ID =
      createField("recipient_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.subscription.amount</code>. */
  public final TableField<SubscriptionRecord, Long> AMOUNT =
      createField("amount", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>DB.subscription.frequency</code>. */
  public final TableField<SubscriptionRecord, Integer> FREQUENCY =
      createField("frequency", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.subscription.time_next</code>. */
  public final TableField<SubscriptionRecord, Integer> TIME_NEXT =
      createField("time_next", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.subscription.height</code>. */
  public final TableField<SubscriptionRecord, Integer> HEIGHT =
      createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>DB.subscription.latest</code>. */
  public final TableField<SubscriptionRecord, Boolean> LATEST =
      createField(
          "latest",
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(
        Indexes.SUBSCRIPTION_PRIMARY,
        Indexes.SUBSCRIPTION_SUBSCRIPTION_ID_HEIGHT_IDX,
        Indexes.SUBSCRIPTION_SUBSCRIPTION_RECIPIENT_ID_HEIGHT_IDX,
        Indexes.SUBSCRIPTION_SUBSCRIPTION_SENDER_ID_HEIGHT_IDX);
  }
  ...
  public List<UniqueKey<SubscriptionRecord>> getKeys() {
    return Arrays.<UniqueKey<SubscriptionRecord>>asList(
        Keys.KEY_SUBSCRIPTION_PRIMARY, Keys.KEY_SUBSCRIPTION_SUBSCRIPTION_ID_HEIGHT_IDX);
  }
