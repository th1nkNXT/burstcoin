...
public class DeeplinkGenerator {
  ...
  public String generateDeepLink(String domain, String action, String base64Payload)
      throws UnsupportedEncodingException, IllegalArgumentException {

    if (!Pattern.matches("^\\w+$", domain)) {
      throw new IllegalArgumentException(
          "Invalid Domain. Must be alphanumeric with optional underscore");
    }
    ...
    if (action != null) {
      ...
      if (base64Payload != null) {
        ...
        if (encodedPayload.length() > MaxPayloadLength) {
          throw new IllegalArgumentException(
              "Maximum Payload Length (" + MaxPayloadLength + ") exceeded");
        }
  ...
  public BufferedImage generateDeepLinkQrCode(String domain, String action, String base64Payload)
      throws UnsupportedEncodingException, IllegalArgumentException, WriterException {
