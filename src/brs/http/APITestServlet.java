...
public class APITestServlet extends HttpServlet {
  ...
  private static final String HEADER_1 =
      "<!DOCTYPE html>\n"
          ...
          + " name=\"viewport\" content=\"width=device-width, initial-scale=1\">    <title>Signum"
          + " node API</title>\n"
          ...
          + " form.elements[i].value != 'submit') {\n"
          + "                    data[form.elements[i].name] = form.elements[i].value;\n"
          + "                    url_get += ((i == 0 && '?') || '&') + form.elements[i].name + '='"
          ...
          + "                  var html = '<a href=\"' + url_get + '\" target=\"_blank\""
          + " style=\"font-size:12px;font-weight:normal;\">Open GET URL</a>';                 "
          ...
          + " style=\"min-width: 90%;\">       <div class=\"navbar-header\">           <a"
          + " class=\"navbar-brand\" href=\""
          + API.API_TEST_PATH
          + "\">Signum node API</a>       </div>       <div class=\"navbar-collapse collapse\">    "
          + "       <ul class=\"nav navbar-nav navbar-right\">               <li><input"
          + " type=\"text\" class=\"form-control\" id=\"search\"                    "
          + " placeholder=\"Search\" style=\"margin-top:8px;\"></li>\n"
          + "               <li><a href=\"https://burstwiki.org/en/the-burst-api/\""
          + " target=\"_blank\" style=\"margin-left:20px;\">Wiki Docs</a></li>               <li><a"
          + " href=\"/doc/index.html\" target=\"_blank\" style=\"margin-left:20px;\">Javadoc"
          + " Index</a></li>           </ul>       </div>   </div></div><div class=\"container\""
          + " style=\"min-width: 90%;\"><div class=\"row\">  <div class=\"col-xs-12\""
          + " style=\"margin-bottom:15px;\">    <div class=\"pull-right\">      <a href=\"#\""
          + " id=\"navi-show-open\">Show Open</a>       |       <a href=\"#\" id=\"navi-show-all\""
          + " style=\"font-weight:bold;\">Show All</a>    </div>  </div></div><div class=\"row\""
          + " style=\"margin-bottom:15px;\">  <div class=\"col-xs-4 col-sm-3 col-md-2\">    <ul"
  ...
  private static final String FOOTER_1 =
      "    </div>   </div> </div> </div> <script src=\"/js/3rdparty/jquery.min.js\""
          + " integrity=\"sha384-tsQFqpEReu7ZLhBV2VZlAu7zcOV+rXbYlF2cqB8txI/8aZajjp4Bqd+V6D5IgvKT\"></script><script"
          + " src=\"/js/3rdparty/bootstrap.min.js\""
          + " integrity=\"sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa\""
          + " type=\"text/javascript\"></script><script>  $(document).ready(function() {   "
          + " apiCalls = [];\n";
  ...
  private final Map<String, APIServlet.HttpRequestHandler> apiRequestHandlers =
      new HashMap<String, APIServlet.HttpRequestHandler>();
  ...
  private String buildLinks(HttpServletRequest req) {
    ...
    for (APITag apiTag : APITag.values()) {
      if (requestTags.get(apiTag.name()) != null) {
        ...
        buf.append("><a href=\"" + API.API_TEST_PATH + "?requestTag=")
            .append(apiTag.name())
            .append("\">");
  ...
  private String form(
    ...
    buf.append("<a data-toggle=\"collapse\" class=\"collapse-link\" data-target=\"#collapse")
        .append(requestType)
        .append("\" href=\"#\">");
    ...
    if (!singleView) {
      ...
      buf.append(
          "\" target=\"_blank\" style=\"font-weight:normal;font-size:14px;color:#777;\"><span"
    ...
    buf.append("<input type=\"hidden\" name=\"requestType\" value=\"")
        .append(requestType)
        .append("\"/>");
    ...
    for (String parameter : parameters) {
      ...
      buf.append("\" name=\"")
          .append(parameter)
          .append("\" style=\"width:100%;min-width:200px;\"/></td>");
      buf.append("</tr>");
    }
    buf.append("<tr>");
    buf.append(
