...
final class SignTransaction extends APIServlet.JsonRequestHandler {
  ...
  JsonElement processRequest(HttpServletRequest req) throws BurstException {
    ...
    String transactionJSON =
        Convert.emptyToNull(req.getParameter(UNSIGNED_TRANSACTION_JSON_PARAMETER));
    ...
    try {
      ...
      if (transaction.getSignature() != null) {
        ...
        response.addProperty(
            ERROR_DESCRIPTION_RESPONSE, "Incorrect unsigned transaction - already signed");
        return response;
      }
      ...
      response.addProperty(ERROR_CODE_RESPONSE, 4);
      response.addProperty(
          ERROR_DESCRIPTION_RESPONSE, "Incorrect unsigned transaction: " + e.toString());
