...
public final class Version {
  ...
  public Version(
      int major, int minor, int patch, PrereleaseTag prereleaseTag, int prereleaseIteration) {
    this.major = major;
    this.minor = minor;
    this.patch = patch;
  ...
  public static Version parse(String version) {
    ...
    try {
      ...
      if (tokenizer.hasMoreTokens()) {
        ...
        int prereleaseIteration =
            prereleaseTagAndIteration.length == 2
                ? Integer.parseInt(prereleaseTagAndIteration[1])
                : -1;
  ...
  public String toString() {
    ...
    String prereleaseSuffix =
        "-" + prereleaseTag.tag + (prereleaseIteration >= 0 ? prereleaseIteration : "");
