...
public interface TransactionProcessor
    extends Observable<List<? extends Transaction>, TransactionProcessor.Event> {
  ...
  void processPeerTransactions(JsonObject request, Peer peer)
  ...
  Transaction.Builder newTransactionBuilder(
