...
public abstract class VersionedEntitySqlTable<T> extends EntitySqlTable<T>
    implements VersionedEntityTable<T> {

  VersionedEntitySqlTable(
      String table,
