...
public class GetAccountSubscriptionsHandler
    implements GrpcApiHandler<BrsApi.GetAccountRequest, BrsApi.Subscriptions> {
  ...
  public BrsApi.Subscriptions handleRequest(BrsApi.GetAccountRequest request) throws Exception {
    ...
    subscriptionService
        .getSubscriptionsByParticipant(accountId)
        .forEach(
            subscription -> builder.addSubscriptions(ProtoBuilder.buildSubscription(subscription)));
