...
public class GetTransactionHandler
    implements GrpcApiHandler<BrsApi.GetTransactionRequest, BrsApi.Transaction> {
  ...
  public BrsApi.Transaction handleRequest(BrsApi.GetTransactionRequest request) throws Exception {
    return ProtoBuilder.buildTransaction(
        getTransaction(blockchain, transactionProcessor, request), blockchain.getHeight());
  }

  public static Transaction getTransaction(
      Blockchain blockchain,
      TransactionProcessor transactionProcessor,
      BrsApi.GetTransactionRequest request)
      throws ApiException {
