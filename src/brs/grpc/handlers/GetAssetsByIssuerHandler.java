...
public class GetAssetsByIssuerHandler
    implements GrpcApiHandler<BrsApi.GetAccountRequest, BrsApi.Assets> {
  ...
  public BrsApi.Assets handleRequest(BrsApi.GetAccountRequest getAccountRequest) throws Exception {
    ...
    assetExchange
        .getAssetsIssuedBy(getAccountRequest.getAccountId(), 0, -1)
