...
public class GetAssetTradesHandler
    implements GrpcApiHandler<BrsApi.GetAssetTransfersRequest, BrsApi.AssetTrades> {
  ...
  @Override
  public BrsApi.AssetTrades handleRequest(BrsApi.GetAssetTransfersRequest request)
      throws Exception {
        ...
        trade ->
            builder.addTrades(
                ProtoBuilder.buildTrade(
                    trade, asset == null ? assetExchange.getAsset(trade.getAssetId()) : asset)));
