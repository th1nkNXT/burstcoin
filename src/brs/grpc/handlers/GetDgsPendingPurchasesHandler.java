...
public class GetDgsPendingPurchasesHandler
    implements GrpcApiHandler<BrsApi.GetDgsPendingPurchasesRequest, BrsApi.DgsPurchases> {
  ...
  @Override
  public BrsApi.DgsPurchases handleRequest(BrsApi.GetDgsPendingPurchasesRequest request)
      throws Exception {
    ...
    digitalGoodsStoreService
        .getPendingSellerPurchases(sellerId, firstIndex, lastIndex)
        .forEach(
            purchase ->
