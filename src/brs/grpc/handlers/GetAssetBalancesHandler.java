...
public class GetAssetBalancesHandler
    implements GrpcApiHandler<BrsApi.GetAssetBalancesRequest, BrsApi.AssetBalances> {
  ...
  @Override
  public BrsApi.AssetBalances handleRequest(BrsApi.GetAssetBalancesRequest request)
      throws Exception {
    ...
    assetExchange
        .getAccountAssetsOverview(asset.getId(), height, firstIndex, lastIndex)
        .forEach(
            assetAccount -> builder.addAssetBalances(ProtoBuilder.buildAssetBalance(assetAccount)));
