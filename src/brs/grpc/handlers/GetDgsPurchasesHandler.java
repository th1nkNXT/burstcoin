...
public class GetDgsPurchasesHandler
    implements GrpcApiHandler<BrsApi.GetDgsPurchasesRequest, BrsApi.DgsPurchases> {
  ...
  public BrsApi.DgsPurchases handleRequest(BrsApi.GetDgsPurchasesRequest request) throws Exception {
    ...
    if (sellerId == 0 && buyerId == 0) {
      ...
      purchases =
          digitalGoodsStoreService.getSellerBuyerPurchases(
              sellerId, buyerId, firstIndex, lastIndex);
    }
