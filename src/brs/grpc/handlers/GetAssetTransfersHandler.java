...
public class GetAssetTransfersHandler
    implements GrpcApiHandler<BrsApi.GetAssetTransfersRequest, BrsApi.AssetTransfers> {
  ...
  @Override
  public BrsApi.AssetTransfers handleRequest(BrsApi.GetAssetTransfersRequest request)
      throws Exception {
        ...
        transfer ->
            builder.addAssetTransfers(
                ProtoBuilder.buildTransfer(
                    transfer,
                    asset == null ? assetExchange.getAsset(transfer.getAssetId()) : asset)));
