...
public class BrsService extends BrsApiServiceGrpc.BrsApiServiceImplBase {
  ...
  private final Map<
          Class<? extends GrpcApiHandler<? extends Message, ? extends Message>>,
          GrpcApiHandler<? extends Message, ? extends Message>>
      handlers;
  ...
  public BrsService(
      ...
      FeeSuggestionCalculator feeSuggestionCalculator,
      ATService atService,
      ...
      DGSGoodsStoreService digitalGoodsStoreService,
    ...
    handlerMap.put(
        BroadcastTransactionHandler.class,
        new BroadcastTransactionHandler(transactionProcessor, blockchain));
    handlerMap.put(
        BroadcastTransactionBytesHandler.class,
        new BroadcastTransactionBytesHandler(transactionProcessor));
    handlerMap.put(
        CompleteBasicTransactionHandler.class,
        new CompleteBasicTransactionHandler(timeService, transactionProcessor, blockchain));
    handlerMap.put(GetAccountATsHandler.class, new GetAccountATsHandler(atService, accountService));
    handlerMap.put(
        GetAccountBlocksHandler.class,
        new GetAccountBlocksHandler(blockchain, blockService, accountService));
    handlerMap.put(
        GetAccountCurrentOrdersHandler.class, new GetAccountCurrentOrdersHandler(assetExchange));
    handlerMap.put(
        GetAccountEscrowTransactionsHandler.class,
        new GetAccountEscrowTransactionsHandler(escrowService));
    ...
    handlerMap.put(
        GetAccountSubscriptionsHandler.class,
        new GetAccountSubscriptionsHandler(subscriptionService));
    handlerMap.put(
        GetAccountTransactionsHandler.class,
        new GetAccountTransactionsHandler(blockchain, accountService));
    ...
    handlerMap.put(
        GetAssetTransfersHandler.class,
        new GetAssetTransfersHandler(assetExchange, accountService));
    ...
    handlerMap.put(
        GetCountsHandler.class,
        new GetCountsHandler(
            accountService, escrowService, blockchain, assetExchange, aliasService, generator));
    ...
    handlerMap.put(
        GetDgsPendingPurchasesHandler.class,
        new GetDgsPendingPurchasesHandler(digitalGoodsStoreService));
    handlerMap.put(
        GetDgsPurchaseHandler.class, new GetDgsPurchaseHandler(digitalGoodsStoreService));
    handlerMap.put(
        GetDgsPurchasesHandler.class, new GetDgsPurchasesHandler(digitalGoodsStoreService));
    handlerMap.put(
        GetEscrowTransactionHandler.class, new GetEscrowTransactionHandler(escrowService));
    handlerMap.put(
        GetMiningInfoHandler.class,
        new GetMiningInfoHandler(blockchainProcessor, blockchain, generator));
    ...
    handlerMap.put(GetPeerHandler.class, new GetPeerHandler());
    handlerMap.put(GetPeersHandler.class, new GetPeersHandler());
    handlerMap.put(
        GetStateHandler.class,
        new GetStateHandler(
            timeService, blockchain, generator, blockchainProcessor, propertyService));
    handlerMap.put(GetSubscriptionHandler.class, new GetSubscriptionHandler(subscriptionService));
    handlerMap.put(
        GetSubscriptionsToAccountHandler.class,
        new GetSubscriptionsToAccountHandler(subscriptionService));
    handlerMap.put(GetTransactionBytesHandler.class, new GetTransactionBytesHandler(blockchain));
    handlerMap.put(
        GetTransactionHandler.class, new GetTransactionHandler(blockchain, transactionProcessor));
    handlerMap.put(
        GetUnconfirmedTransactionsHandler.class,
        new GetUnconfirmedTransactionsHandler(indirectIncomingService, transactionProcessor));
    handlerMap.put(ParseTransactionHandler.class, new ParseTransactionHandler());
    handlerMap.put(
        SubmitNonceHandler.class,
        new SubmitNonceHandler(propertyService, blockchain, accountService, generator));
  ...
  public Server start(String hostname, int port) throws IOException {
    if (Objects.equals(hostname, "0.0.0.0")) {
      ...
      return NettyServerBuilder.forAddress(new InetSocketAddress(hostname, port))
          .addService(this)
          .build()
          .start();
    }
  ...
  private <H extends GrpcApiHandler<R, S>, R extends Message, S extends Message> void handleRequest(
      Class<H> handlerClass, R request, StreamObserver<S> response) {
    ...
    if (handlerClass != null && handlerClass.isInstance(handler)) {
      ...
      response.onError(
          ProtoBuilder.buildError(
              new HandlerNotFoundException("H not registered: " + handlerClass)));
    }
  }
  ...
  public void submitNonce(
      BrsApi.SubmitNonceRequest request,
      StreamObserver<BrsApi.SubmitNonceResponse> responseObserver) {
    handleRequest(SubmitNonceHandler.class, request, responseObserver);
  }

  @Override
  public void getAccount(
      BrsApi.GetAccountRequest request, StreamObserver<BrsApi.Account> responseObserver) {
    handleRequest(GetAccountHandler.class, request, responseObserver);
  }

  @Override
  public void getAccounts(
      BrsApi.GetAccountsRequest request, StreamObserver<BrsApi.Accounts> responseObserver) {
    handleRequest(GetAccountsHandler.class, request, responseObserver);
  }

  @Override
  public void getBlock(
      BrsApi.GetBlockRequest request, StreamObserver<BrsApi.Block> responseObserver) {
    handleRequest(GetBlockHandler.class, request, responseObserver);
  }

  @Override
  public void getTransaction(
      BrsApi.GetTransactionRequest request, StreamObserver<BrsApi.Transaction> responseObserver) {
    handleRequest(GetTransactionHandler.class, request, responseObserver);
  }

  @Override
  public void getTransactionBytes(
      BrsApi.BasicTransaction request, StreamObserver<BrsApi.TransactionBytes> responseObserver) {
    handleRequest(GetTransactionBytesHandler.class, request, responseObserver);
  }

  @Override
  public void completeBasicTransaction(
      BrsApi.BasicTransaction request, StreamObserver<BrsApi.BasicTransaction> responseObserver) {
  ...
  public void broadcastTransaction(
      BrsApi.BasicTransaction request,
      StreamObserver<BrsApi.TransactionBroadcastResult> responseObserver) {
    handleRequest(BroadcastTransactionHandler.class, request, responseObserver);
  }

  @Override
  public void broadcastTransactionBytes(
      BrsApi.TransactionBytes request,
      StreamObserver<BrsApi.TransactionBroadcastResult> responseObserver) {
  ...
  public void getPeers(
      BrsApi.GetPeersRequest request, StreamObserver<BrsApi.Peers> responseObserver) {
  ...
  public void parseTransaction(
      BrsApi.TransactionBytes request, StreamObserver<BrsApi.BasicTransaction> responseObserver) {
    handleRequest(ParseTransactionHandler.class, request, responseObserver);
  }

  @Override
  public void getAccountATs(
      BrsApi.GetAccountRequest request, StreamObserver<BrsApi.AccountATs> responseObserver) {
  ...
  public void getAlias(
      BrsApi.GetAliasRequest request, StreamObserver<BrsApi.Alias> responseObserver) {
    handleRequest(GetAliasHandler.class, request, responseObserver);
  }

  @Override
  public void getAliases(
      BrsApi.GetAliasesRequest request, StreamObserver<BrsApi.Aliases> responseObserver) {
    handleRequest(GetAliasesHandler.class, request, responseObserver);
  }

  @Override
  public void getUnconfirmedTransactions(
      BrsApi.GetAccountRequest request,
      StreamObserver<BrsApi.UnconfirmedTransactions> responseObserver) {
    handleRequest(GetUnconfirmedTransactionsHandler.class, request, responseObserver);
  }

  @Override
  public void getAccountBlocks(
      BrsApi.GetAccountBlocksRequest request, StreamObserver<BrsApi.Blocks> responseObserver) {
    handleRequest(GetAccountBlocksHandler.class, request, responseObserver);
  }

  @Override
  public void getAccountCurrentOrders(
      BrsApi.GetAccountOrdersRequest request, StreamObserver<BrsApi.Orders> responseObserver) {
  ...
  public void getAssetTransfers(
      BrsApi.GetAssetTransfersRequest request,
      StreamObserver<BrsApi.AssetTransfers> responseObserver) {
    handleRequest(GetAssetTransfersHandler.class, request, responseObserver);
  }

  @Override
  public void getBlocks(
      BrsApi.GetBlocksRequest request, StreamObserver<BrsApi.Blocks> responseObserver) {
  ...
  public void getDgsGood(
      BrsApi.GetByIdRequest request, StreamObserver<BrsApi.DgsGood> responseObserver) {
    handleRequest(GetDgsGoodHandler.class, request, responseObserver);
  }

  @Override
  public void getDgsGoods(
      BrsApi.GetDgsGoodsRequest request, StreamObserver<BrsApi.DgsGoods> responseObserver) {
    handleRequest(GetDgsGoodsHandler.class, request, responseObserver);
  }

  @Override
  public void getDgsPendingPurchases(
      BrsApi.GetDgsPendingPurchasesRequest request,
      StreamObserver<BrsApi.DgsPurchases> responseObserver) {
    handleRequest(GetDgsPendingPurchasesHandler.class, request, responseObserver);
  }

  @Override
  public void getDgsPurchase(
      BrsApi.GetByIdRequest request, StreamObserver<BrsApi.DgsPurchase> responseObserver) {
    handleRequest(GetDgsPurchaseHandler.class, request, responseObserver);
  }

  @Override
  public void getDgsPurchases(
      BrsApi.GetDgsPurchasesRequest request, StreamObserver<BrsApi.DgsPurchases> responseObserver) {
    handleRequest(GetDgsPurchasesHandler.class, request, responseObserver);
  }

  @Override
  public void getEscrowTransaction(
      BrsApi.GetByIdRequest request, StreamObserver<BrsApi.EscrowTransaction> responseObserver) {
    handleRequest(GetEscrowTransactionHandler.class, request, responseObserver);
  }

  @Override
  public void getOrder(
      BrsApi.GetOrderRequest request, StreamObserver<BrsApi.Order> responseObserver) {
    handleRequest(GetOrderHandler.class, request, responseObserver);
  }

  @Override
  public void getOrders(
      BrsApi.GetOrdersRequest request, StreamObserver<BrsApi.Orders> responseObserver) {
    handleRequest(GetOrdersHandler.class, request, responseObserver);
  }

  @Override
  public void getSubscription(
      BrsApi.GetByIdRequest request, StreamObserver<BrsApi.Subscription> responseObserver) {
